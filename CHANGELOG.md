...
### Added
- **Continuous Changelog Policy**: Added a mandatory rule to `skill/github-release-management.md` requiring all Pull Requests to accumulate changelog entries synchronously.
