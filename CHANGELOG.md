...
### Added
- **Dynamic Color Correction**: Replaced static LUTs with a dynamic `colorchannelmixer` filter that mathematically multiplies the red channel based on current dive depth (scaling from 1.0x at surface to 2.5x at 30 meters), perfectly recovering warm colors without ruining pure black shadows.
