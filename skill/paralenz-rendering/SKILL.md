...
- **Test Command:** You MUST run the test suite via `uv run --with pytest --with pytest-cov pytest --cov=scripts tests/` locally and ensure all tests pass and coverage requirements are met before committing any code.
